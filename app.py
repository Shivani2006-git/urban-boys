...
# Using port 5432 (Session Pooler) - Simpler mode, often resolves tenant routing issues
DB_URI = f"postgresql://postgres.gzgmaclzucnifunkkkgl:{encoded_password}@aws-0-ap-south-1.pooler.supabase.com:5432/postgres"
